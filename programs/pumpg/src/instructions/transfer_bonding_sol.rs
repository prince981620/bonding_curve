...
// use crate::{errors::Errors, BondingCurve, FundsWithdrawn, Global, BONDING_CURVE, CURVE_VAULT, GLOBAL, MIGRATION_FEE};
...
//     #[account(
//         mut,
//         address = pubkey!("So11111111111111111111111111111111111111112")
//     )]
...
//     pub fn transfer_sol (&mut self, remaining_sol:u64) -> Result<()> {
